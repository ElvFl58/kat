...
export default function RomanticGallery() {
  ...
  return (
    <section className="relative min-h-screen py-16 px-6 bg-gradient-to-b from-pink-100 via-rose-50 to-pink-200 overflow-hidden">
      {/* Título */}
      <div className="text-center mb-14 animate-glow">
        <h1 className="text-5xl sm:text-7xl font-dancing text-rose-600 drop-shadow-lg">
          🌸 Galería de Kat 🌸
        </h1>
        <p className="mt-3 text-lg sm:text-2xl text-rose-500 font-dosis">
